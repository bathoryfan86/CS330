...
{
    // Load the abstract texture for the plane
    CreateGLTexture("../../Utilities/textures/abstract.jpg", "abstractTexture");

    // Load the rug texture for the cone
    CreateGLTexture("../../Utilities/textures/rug.jpg", "rugTexture");

    // Load the silver texture for the sphere
    CreateGLTexture("../../Utilities/textures/silver.jpg", "silverTexture");

    // Load the backdrop texture for the middle part
    CreateGLTexture("../../Utilities/textures/backdrop.jpg", "backdropTexture");

    // Load the pavers texture for the box
    CreateGLTexture("../../Utilities/textures/pavers.jpg", "paversTexture");
...
void SceneManager::RenderScene() {
    ...
    SetTransformations(scaleXYZ, 0.0f, 0.0f, 0.0f, positionXYZ);
    SetShaderTexture("cheddarTexture");
    m_basicMeshes->DrawCylinderMesh();
    ...
    SetTransformations(scaleXYZ, 0.0f, 0.0f, 0.0f, positionXYZ);
    SetShaderTexture("abstractTexture");
    m_basicMeshes->DrawCylinderMesh();
    ...
    SetTransformations(scaleXYZ, 0.0f, 0.0f, 0.0f, positionXYZ);
    SetShaderTexture("glass_lampTexture");
    m_basicMeshes->DrawCylinderMesh();
    ...
    SetShaderTexture("cheese_wheelTexture");
